...
document.addEventListener('DOMContentLoaded', () => {
  ...
  cantidadInput.addEventListener('input', () => {
    ...
    btnAgregar.disabled = cantidadInput.value <= 0 || !cantidadInput.value;
  });
...
document.getElementById('formVender').addEventListener('submit', async (e) => {
  ...
  try {
    ...
    alert(result.message);
    listarProductos();
    totalVentas = 0; // Reiniciar total al registrar la venta
...
function llenarModalVenta(prod) {
  document.getElementById('venderIdProducto').value = prod.idProducto;
  document.getElementById('venderStockDisponible').value = prod.stock;
  ...
  document.getElementById('venderTotal').value = '';
  totalVentas = 0; // Reiniciar total al abrir el modal
  calcularSubtotal();
...
function agregarProducto() {
  ...
  document.getElementById('venderCantidad').value = 1; // Reiniciar cantidad para agregar otro producto
  document.getElementById('venderSubtotal').value = '0.00'; // Reiniciar subtotal
}
