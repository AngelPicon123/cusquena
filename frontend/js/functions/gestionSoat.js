    ...
    searchInput.addEventListener('input', () => {
        ...
        async function updateSoat(idSoat) {
            try {
              const formData = {
                ...
                alert('SOAT actualizado correctamente');
        ...
        function confirmDelete(idSoat) {
            if (confirm('¿Está seguro que desea eliminar este SOAT?')) {
                deleteSoat(idSoat);
            }
        }
        ...
        async function deleteSoat(idSoat) {
            try {
                ...
                alert('SOAT eliminado correctamente');
                loadSoats(searchInput.value, currentPage);
            } catch (error) {
                console.error('Error:', error);
                alert('Error al eliminar SOAT: ' + error.message);
            }
        }
