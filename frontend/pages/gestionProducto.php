        ...
        <div class="container-fluid px-4">
            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="miModalLabel">Registro de Producto</h3>
                ...
                <div class="modal-body">
                  <form id="formAgregar">
                    ...
                    <div class="mb-3">
                      <label for="precioVenta" class="form-label fw-bold">Precio de Venta:</label>
                ...
                <div class="modal-body">
                  <form id="formEditar">
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-select" id="editarCategoria" required></select>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3 d-flex align-items-center">
                      <label class="form-label me-3 fw-bold">Estado:</label>
                      <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" name="editarEstado" id="editarEstadoActivo" value="activo">
                        <label class="form-check-label" for="editarEstadoActivo">Activo</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" name="editarEstado" id="editarEstadoInactivo" value="inactivo">
          ...
          <div class="modal fade" id="modalVender">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="formVender">
                    <input type="hidden" id="venderIdProducto">
                    <input type="hidden" id="venderStockDisponible">
                    <div class="mb-3">
                      <label for="venderDescripcion" class="form-label fw-bold">Descripción:</label>
                      <input type="text" class="form-control" id="venderDescripcion" name="descripcion" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="venderPrecioUnitario" class="form-label fw-bold">Precio Unitario:</label>
                      <input type="number" step="0.01" class="form-control" id="venderPrecioUnitario" name="precioUnitario" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="venderCantidad" class="form-label fw-bold">Cantidad:</label>
                      <input type="number" class="form-control" id="venderCantidad" name="cantidad" min="1" placeholder="Ingresa la cantidad a vender" required>
                    </div>
                    <div class="mb-3">
                      <label for="venderSubtotal" class="form-label fw-bold">Subtotal:</label>
                      <input type="number" step="0.01" class="form-control" id="venderSubtotal" name="subtotal" readonly>
                    </div>
                    <div class="mb-3">
                      <label for="venderFecha" class="form-label fw-bold">Fecha:</label>
                      <input type="text" class="form-control" id="venderFecha" name="fecha" placeholder="dd/mm/aaaa" required>
                    </div>
                    <div class="modal-footer d-flex justify-content-between">
                      <button type="button" class="btn btn-primary" id="btnAgregarProducto">Agregar Producto</button>
                      <input type="text" class="form-control w-25" id="venderTotal" placeholder="Total" readonly>
          ...
          <div class="table-responsive my-4">
            <table class="table table-bordered table-hover text-center">
              ...
              <tbody class="align-middle" id="tablaProductos"></tbody>
            </table>
          </div>
          <!-- Fin Tabla -->
