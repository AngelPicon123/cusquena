...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2025 at 05:29 PM
...
--
-- Indexes for table `detalleventaservicio`
--
ALTER TABLE `detalleventaservicio`
  ADD PRIMARY KEY (`idDetalleVentaServicio`),
  ADD KEY `idServicio` (`idServicio`),
  ADD KEY `idVentaServicio` (`idVentaServicio`);
...
--
-- Indexes for table `ventaservicio`
--
...
--
-- AUTO_INCREMENT for table `detalleventaservicio`
--
ALTER TABLE `detalleventaservicio`
...
--
ALTER TABLE `ingresoproducto`
  MODIFY `idIngresoProducto` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `ventaservicio`
--
ALTER TABLE `ventaservicio`
...
--
-- Constraints for table `detalleventaservicio`
--
ALTER TABLE `detalleventaservicio`
  ADD CONSTRAINT `detalleventaservicio_ibfk_1` FOREIGN KEY (`idServicio`) REFERENCES `servicio` (`idServicio`),
  ADD CONSTRAINT `detalleventaservicio_ibfk_2` FOREIGN KEY (`idVentaServicio`) REFERENCES `ventaservicio` (`idVentaServicio`);
